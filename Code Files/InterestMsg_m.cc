...
int InterestMsg::getInterest() const
{
    return this->interest;
}

void InterestMsg::setInterest(int interest)
{
    this->interest = interest;
}

int InterestMsg::getSaddress() const
{
    return this->saddress;
}

void InterestMsg::setSaddress(int saddress)
{
...
InterestMsgDescriptor::InterestMsgDescriptor() : omnetpp::cClassDescriptor("InterestMsg", "omnetpp::cPacket")
{
...
int InterestMsgDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='s' && strcmp(fieldName, "saddress")==0) return base+1;
...
int InterestMsgDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    InterestMsg *pp = (InterestMsg *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

const char *InterestMsgDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string InterestMsgDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    InterestMsg *pp = (InterestMsg *)object; (void)pp;
    switch (field) {
        case 0: return long2string(pp->getInterest());
        case 1: return long2string(pp->getSaddress());
        default: return "";
    }
}

bool InterestMsgDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    InterestMsg *pp = (InterestMsg *)object; (void)pp;
    switch (field) {
        case 0: pp->setInterest(string2long(value)); return true;
        case 1: pp->setSaddress(string2long(value)); return true;
...
void *InterestMsgDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
